import {
    ...
    visitNode, visitEachChild, Transformer, Program, factory, isCallExpression, isConstructorDeclaration, isIdentifier, isInterfaceDeclaration, isParameter, SyntaxKind, updateSourceFile, updateSourceFileNode
} from 'typescript'
...
export function transformer(program: Program, /* opts?: TransformerOptions */) {
